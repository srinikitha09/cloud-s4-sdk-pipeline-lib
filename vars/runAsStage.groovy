...
private getContainerList(script, def config, String stageName) {
    ...
    echo "it ${script}"
    echo "it ${script.commonPipelineEnvironment}"
    echo "it ${script.commonPipelineEnvironment.configuration}"
    echo "it ${script.commonPipelineEnvironment.configuration.k8sMapping}"
    echo "it ${script.commonPipelineEnvironment.configuration.k8sMapping.stageName}"
